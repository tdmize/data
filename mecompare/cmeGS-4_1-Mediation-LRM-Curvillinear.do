capture log close
log using cmeGS-4_1-Mediation-LRM-Curvillinear, replace text

// CME: Comparing Marginal Effects Across Models
// Mize, Doan, and Long
// Example 4.1: Mediation with curvilinear relationship
...
*save graph
graph export "cmeS-4_1-model_1.png", replace
...
*save graph
graph export "cmeS-4_1-model_2.png", replace
