capture log close
log using cmeGS-4_3-Variable-Choice-Predictors, replace text

// CME: Comparing Marginal Effects Across Models
// Mize, Doan, and Long
// Variable choice: Ex 4.3 Comparing effets of alterantive predictors
...
*NOTE_3: for nominal and binary IVs, dydx( ) option on margins will
...
*NOTE_5: Option predict(outcome( )) allows for predictions from a specific
...
*save graph	
graph export "cmeS-4_3-pr_prob.png", replace
